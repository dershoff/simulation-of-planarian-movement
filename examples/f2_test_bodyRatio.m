...
c_temp = [0 0 0];
for i = 1:length(bodyRatios)    
    opts.worm.bodyRatio = bodyRatios(i);
...
subplot(1,2,1)
legend(strread(num2str(bodyRatios), '%s'),'location','southeast')
subplot(1,2,2)
legend(strread(num2str(bodyRatios), '%s'))
